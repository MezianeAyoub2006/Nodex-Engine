...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 20), // _Bool()(void)
/*  1 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  2 */ _CFFI_OP(_CFFI_OP_FUNCTION, 23), // void()(Color)
/*  3 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // Color
/*  4 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION, 23), // void()(int)
/*  6 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/*  7 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  8 */ _CFFI_OP(_CFFI_OP_FUNCTION, 23), // void()(int, int, char const *)
/*  9 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/* 10 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7),
/* 11 */ _CFFI_OP(_CFFI_OP_POINTER, 21), // char const *
/* 12 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 13 */ _CFFI_OP(_CFFI_OP_FUNCTION, 23), // void()(unsigned int)
/* 14 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 8), // unsigned int
/* 15 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 16 */ _CFFI_OP(_CFFI_OP_FUNCTION, 23), // void()(void)
/* 17 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 18 */ _CFFI_OP(_CFFI_OP_ENUM, 0), // ConfigFlags
/* 19 */ _CFFI_OP(_CFFI_OP_ENUM, 1), // TraceLogLevel
/* 20 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 1), // _Bool
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "BeginDrawing", (void *)_cffi_f_BeginDrawing, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 16), (void *)_cffi_d_BeginDrawing },
  { "ClearBackground", (void *)_cffi_f_ClearBackground, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 2), (void *)_cffi_d_ClearBackground },
  { "ClearWindowState", (void *)_cffi_f_ClearWindowState, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 13), (void *)_cffi_d_ClearWindowState },
  { "CloseWindow", (void *)_cffi_f_CloseWindow, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 16), (void *)_cffi_d_CloseWindow },
  { "EndDrawing", (void *)_cffi_f_EndDrawing, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 16), (void *)_cffi_d_EndDrawing },
  ...
  { "InitWindow", (void *)_cffi_f_InitWindow, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 8), (void *)_cffi_d_InitWindow },
  ...
  { "SetConfigFlags", (void *)_cffi_f_SetConfigFlags, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 13), (void *)_cffi_d_SetConfigFlags },
  { "SetTraceLogLevel", (void *)_cffi_f_SetTraceLogLevel, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 5), (void *)_cffi_d_SetTraceLogLevel },
  { "WindowShouldClose", (void *)_cffi_f_WindowShouldClose, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 0), (void *)_cffi_d_WindowShouldClose },
};
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "Color", 3, _CFFI_F_CHECK_FIELDS,
    sizeof(Color), offsetof(struct _cffi_align__Color, y), 0, 4 },
};

static const struct _cffi_enum_s _cffi_enums[] = {
  { "$ConfigFlags", 18, _cffi_prim_int(sizeof(ConfigFlags), ((ConfigFlags)-1) <= 0),
    "FLAG_VSYNC_HINT,FLAG_WINDOW_HIDDEN" },
  { "$TraceLogLevel", 19, _cffi_prim_int(sizeof(TraceLogLevel), ((TraceLogLevel)-1) <= 0),
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__ndx_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
     PyInit__ndx_cffi(void) { return NULL; }
#  endif
#else
PyMODINIT_FUNC
PyInit__ndx_cffi(void)
{
  return _cffi_init("_ndx_cffi", 0x2601, &_cffi_type_context);
}
#endif
